...
<table class="table">
  ...
  <tbody>
    <tr>
	    ...
	    <tr>
	      <td>cert-manager</td>
	      <td title='A Helm chart for cert-manager'><a href='https://cert-manager.io'> <img src='https://raw.githubusercontent.com/cert-manager/community/4d35a69437d21b76322157e6284be4cd64e6d2b7/logo/logo-small.png' width='24px' height='24px'> cert-manager</a></td>
	      <td>v1.15.0</td>
	      <td></td>
    ...
    <tr>
	    ...
	    <tr>
	      <td>external-dns</td>
	      <td title='ExternalDNS is a Kubernetes addon that configures public DNS servers with information about exposed Kubernetes services to make them discoverable.'><a href='https://bitnami.com'> <img src='https://bitnami.com/assets/stacks/external-dns/img/external-dns-stack-220x234.png' width='24px' height='24px'> external-dns</a></td>
	      <td>6.20.3</td>
	      <td></td>
	      <td><a href='https://github.com/bitnami/charts/tree/main/bitnami/external-dns'>source</a></td>
	    </tr>
    <tr>
    ...
    <tr>
	      ...
	      <td>1.8.2</td>
	      <td><a href='https://dashboard-jx.jenkinx.auroraverusschool.org'>view</a></td>
    ...
    <tr>
	      ...
	      <td>0.1.0</td>
	      <td></td>
	      <td><a href='https://github.com/jenkins-x/acme.git'>source</a></td>
	    </tr>
    <tr>
