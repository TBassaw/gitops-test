...
#	find $(OUTPUT_DIR) -type f -name "kubernetes-external-secrets-deploy.yaml" -exec sed -i '/kind: Deployment/,/kubernetes-external-secrets:/ { s/"http://127.0.0.1:8200"/"https://vault.jx-vault:8200"/; }' {} +
